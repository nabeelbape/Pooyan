...
public class Level2 extends LevelBase implements KeyListener, ActionListener {
	...
	Timer tim1, tim2;
	String iconPath = Constants.ICON_PATH_NIGHT;

	public Level2(int previousScore) {
		super("Pooyan - Level 2");
		...
		addKeyListener(this);
		JOptionPane.showMessageDialog(this, Constants.LEVEL2_START_MESSAGE, "Level 2", JOptionPane.INFORMATION_MESSAGE);
		tim2.start();
	}
