...
class Level2 extends JFrame implements KeyListener,ActionListener
{
	...
	int scoreNum=0,livesNum=5,wolvesLeft=50;
	Point wolfPosition,arrowPosition;
	Timer tim1,tim2;
	
	Level2(int previousScore)
	{
		super("Pooyan");
		scoreNum=previousScore;
		...
		lift=new JLabel(new ImageIcon("icons2/piggy2.png"));
		building=new JLabel(new ImageIcon("icons2/building2.png"));
		mountain=new JLabel(new ImageIcon("icons2/mountain.png"));
		
		score=new JLabel("Score : "+scoreNum);
		lives=new JLabel("Lives : 5");
		
		arrow=new JLabel[2];
		arrow[0]=new JLabel(new ImageIcon("icons2/arrow.png"));
		arrow[1]=new JLabel(new ImageIcon("icons2/redarrow.png"));
	...
	public void keyPressed(KeyEvent ke)
	{
		...
		if(ke.getKeyCode()==KeyEvent.VK_SPACE)
		{
			...
			if(tim1.isRunning()==false)
			{
				...
				{
					power=true;
					lift.setIcon(new ImageIcon("icons2/piggy3.png"));
				}
				else
				{
					power=false;
					lift.setIcon(new ImageIcon("icons2/piggy2.png"));	
				}
			}
		}
	}
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==tim2)
		{
			...
			for(i=0;i<9;i++)
			{
				...
				//System.out.println("availableWolf["+i+"] = "+ availableWolf[i]);
				if(availableWolf[i]==0)
				{
					System.out.println("Wolf["+i+"] : upDown = "+upDown[i]+" : Wolvesleft = " +wolvesLeft);
					if(upDown[i]==1)
					{
				...
				else if(availableWolf[i]==1 && nextCounter==0)
				{
					...
					picVal[i]=randomPic;					
					wolf[i].setIcon(new ImageIcon("icons2/wolf"+randomPic+".png"));
				...
				if(arrowNum==0) // for normal arrow
				{
					...
					{
						wolf[i].setIcon(new ImageIcon("icons2/fallingWolf"+picVal[i]+".png"));
			...
			if(wolvesLeft<=0 && livesNum>0)
			{
				tim1.stop();
				tim2.stop();
				JOptionPane.showMessageDialog(this,"Game completed\nYour Score is "+scoreNum,"Congratulations",JOptionPane.INFORMATION_MESSAGE);
				dispose();
			}
			if(livesNum<=0)
			{
